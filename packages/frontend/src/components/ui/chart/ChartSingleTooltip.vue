...
// @ts-nocheck - unovis type compatibility
...
function template(d: any, i: number, elements: (HTMLElement | SVGElement)[]) {
  ...
  if (props.index in d) {
    if (wm.has(d)) {
      ...
      // eslint-disable-next-line vue/one-component-per-file -- Creating app instance for dynamic tooltip rendering, not defining a component
